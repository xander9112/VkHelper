...
class Component extends React.Component<IProps, IState> {
  ...
  private handleSelect = (photo) => {
    this.props.handleSelect("to", photo);
  };
  ...
  private handleChange = (value) => {
    ...
    this.props.getPhotos("TO", {owner_id: group.id, album_id: value.album});
  };
}

export const RightSide = withStyles(styles, {withTheme: true})(Component);
